...
const ResponsiveIcons = {
    ...
    reduxtoolkit: { name: "Redux Toolkit", icon: <TbBrandRedux className="icons" /> },
    redux: { name: "Redux", icon: <TbBrandRedux className="icons" /> },
    ...
    sklearn: { name: "scikit-learn", icon: <SiScikitlearn className="icons" /> },
    wordcloud: { name: "WordCloud" },
    textblob: { name: "TextBlob" },
    matplotlib: { name: "Matplotlib" },
    pandas: { name: "Pandas", icon: <SiPandas className="icons" /> },
    scipy: { name: "SciPy", icon: <SiScipy className="icons" /> },
    pygad: { name: "PyGAD" },
    gari: { name: "GARI", fullName: "Genetic Algorithm for Reproducing Images" },
    imageio: { name: "Imageio", icon: <IoImage className="icons" /> },
    pyswarms: { name: "PySwarms" },
    pygame: { name: "Pygame" },
    beautifulsoup: { name: "Beautiful Soup" },
    seaborn: { name: "Seaborn" },
    plotly: { name: "Plotly", icon: <SiPlotly className="icons" /> },
    pytest: { name: "PyTest", icon: <SiPytest className="icons" /> },
    ...
    awsec2: { name: "AWS_EC2", icon: <SiAmazonec2 className="icons" />, fullName: "Amazon Elastic Cloud Compute" },
    awsrds: {
        name: "AWS_RDS",
        icon: <SiAmazonrds className="icons" />,
        fullName: "Amazon Relational Database Service",
    },
    awss3: { name: "AWS_S3", icon: <SiAmazons3 className="icons" />, fullName: "Amazon Simple Storage Service" },
    gcp: { name: "GCP", icon: <SiGooglecloud className="icons" />, fullName: "Google Cloud Platform" },
    gcpgce: { name: "GCP_GCE", icon: <DiGoogleCloudPlatform className="icons" />, fullName: "Google Compute Engine" },
    gcpfirestore: { name: "Firestore", icon: <SiFirebase className="icons" />, fullName: "Google Firestore" },
    ...
    sqlite: { name: "SQLite", icon: <SiSqlite className="icons" /> },
    vectordb: { name: "Vector DB", icon: <AiFillDatabase className="icons" /> },
    ...
    fedora: { name: "Fedora", icon: <SiFedora className="icons" /> },

    // technologies"}

    // apps
    pycharm: { name: "PyCharm", icon: <SiPycharm className="icons" /> },
    vscode: { name: "VSCode", icon: <SiVisualstudiocode className="icons" />, fullName: "Visual Studio Code" },
    ...
    colab: { name: "Colab", icon: <SiGooglecolab className="icons" />, fullName: "Google Colaboratory" },
    ...
    agile: { name: "Agile", icon: <DiScrum className="icons" /> },
    waterfall: { name: "Waterfall", icon: <MdWaterfallChart className="icons" /> },
};
