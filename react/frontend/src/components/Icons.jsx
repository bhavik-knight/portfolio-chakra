...
const size = { base: "16px", md: "18px", lg: "20px" };

const Numpy = () => (
    <Container
        bgImage="./logos/numpy.svg"
        boxSize={size}
    />
);
...
const Pandas = () => (
    <Container
        bgImage="./logos/pandas.svg"
        boxSize={size}
    />
);
const MatPlotLib = () => (
    <Container
        bgImage="./logos/matplotlib.svg"
        boxSize={size}
    />
);
const Seaborn = () => (
    <Container
        bgImage="./logos/seaborn.svg"
        boxSize={size}
    />
);
const Plotly = () => (
    <Container
        bgImage="./logos/plotly.svg"
        boxSize={size}
    />
);
const ScikitLearn = () => (
    <Container
        bgImage="./logos/scikitLearn.svg"
        boxSize={size}
    />
);
